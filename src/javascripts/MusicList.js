...
musicList =[
	{
		...
		"smallDesc":"1773年(17歳)",
		"bigDesc":"『交響曲第25番ト短調』は、モーツァルトによる1773年作曲の交響曲。映画「アマデウス」の冒頭部分で使用されたことでも有名。</br>交響曲第40番ト短調に対して「小ト短調」ともよばれる。モーツァルトの交響曲のうち、短調で書かれているのはこの第25番と第40番のみ。</br>交響曲第25番の作曲当時、まだモーツァルトは弱冠17歳だった。</br>当時の交響曲には15歳でのイタリア旅行の影響が残っていたが、3回目のウィーン旅行をきっかけに、ハイドンらの影響を強く受けたシンフォニーを生み出していった。",
	...
	},
	{
		...
		"smallDesc":"1786年(30歳)",
		"bigDesc":"『フィガロの結婚 序曲』は、モーツァルト作曲の同名のオペラ（歌劇）で演奏される、現代でも人気の高い序曲。</br>流麗かつ華麗な曲調で、現代ではモーツァルトの序曲の中で一・二を争うほどの人気があり、コンサートでは序曲単独で演奏されることも多い。</br>2006年のニューイヤーコンサートでは、モーツァルト生誕250周年記念の特例として演奏された。</br>なお、同オペラの楽曲としては、第二幕でケルビーノが歌う劇中歌『恋とはどんなものかしら』も有名",
	...
	},
	{
		...
		"smallDesc":"1788(32歳)",
		"bigDesc":"旧モーツァルト全集では「第15番」、新モーツァルト全集では「第16番」とナンバリングされている。</br>「初心者のための小さなソナタ」と銘打たれたこの作品は、ソナチネアルバムにも収められ、ピアノ学習者にはおなじみの曲。</br>特に第一楽章（Allegro ハ長調）は、アニメ「ママは小学4年生」（1992年）エンディング曲『この愛を未来へ』（歌：岩崎宏美）としてカバーされるなど、一般にもメロディーの知名度は比較的高い",
	...
	{
		"artistName":"夜の女王のアリア</br>復讐の炎は地獄のように我が心に燃え",
		"title":"モーツァルト 歌劇『魔笛』第2幕より",
		"smallDesc":"1791年(35歳)",
		"bigDesc":"『夜の女王のアリア（復讐の炎は地獄のように我が心に燃え）』は、モーツァルトの歌劇『魔笛（まてき/The Magic Flute K.620）』の第2幕に登場するアリア。</br>原題は「Der Hölle Rache kocht in meinem Herzen」。英題は「Hell's vengeance boils in my heart」。</br>歌劇『魔笛』は、モーツァルトが生涯の最後に完成させたオペラ。初演は1791年9月30日ヴィーデン劇場。</br>台本は興業主・俳優・歌手のエマヌエル・シカネーダーが自分の一座のために書き上げた。",
	...
	},
	{
		...
		"smallDesc":"1791年(35歳)",
		"bigDesc":"『レクイエム（モーツァルト）』は、モーツァルト最後の作品（K. 626）で、モーツァルトの死により作品は未完のまま残されたミサ曲。<br>後に弟子のフランツ・クサーヴァー・ジュースマイヤーにより補筆完成された。しばしば、ヴェルディ、フォーレの作品とともに「三大レクイエム」の一つに数えられる。</br>全14曲から構成され、中でも「第3曲 怒りの日」（ニ短調 アレグロ・アッサイ 4分の4拍子 合唱）はテレビや映画などでよく用いられるなど有名な曲。",
